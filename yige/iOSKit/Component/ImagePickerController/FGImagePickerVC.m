...
- (void)pushTZImagePickerController {
    ...
    TZImagePickerController *imagePickerVc = [[TZImagePickerController alloc] initWithMaxImagesCount:self.maxCountTF - [[self getUrlsArr] count] columnNumber:self.columnNumberTF delegate:self pushPhotoPickerVc:YES];
